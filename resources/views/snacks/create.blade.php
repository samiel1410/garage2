    ...
    <div class="card">
        ...
        <div class="form-group">
            <label for="disponible">Disponible</label>
                        <input class="form-control Boolean"  type="radio"  name="disponible" id="disponible" value="{{('1')}}"                         required="required"
                        >
           
            
            <label for="disponible">No Disponible</label>
                        <input class="form-control Boolean"  type="radio"  name="disponible" id="disponible" value="{{('0')}}"                         required="required"
                        >
